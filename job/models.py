...
class Job_list(models.Model):
    ...
    job_name = models.CharField(max_length=20, verbose_name=u'作业名称')
    ...
    job_start_time = models.CharField(max_length=20,verbose_name=u'开始时间')
    job_run_time = models.CharField(max_length=20,verbose_name=u'运行时间')
