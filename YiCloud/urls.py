...
from clusmgr.views import dir_tree,file_tree,mgr_file_index,get_dir_content,mgr_dir_tree,mgr_process,vnc_login,\
                            file_upload,file_download,file_upload_index,file_delete,process_stop
...
urlpatterns = [
    ...
    url(r'^schedmgr/mgr_node_sched_index/$', mgr_node_sched_index, name='mgr_node_sched_index'),
    url(r'^schedmgr/mgr_node_sched/$', mgr_node_sched, name='mgr_node_sched'),
    url(r'^schedmgr/get_node_sched/$', get_node_sched, name='get_node_sched'),
    ...
    url(r'^schedmgr/mgr_user_sched_index/$', mgr_user_sched_index, name='mgr_user_sched_index'),
    url(r'^schedmgr/get_user_sched/$', get_user_sched, name='get_user_sched'),
    ...
    url(r'^clusmgr/mgr_file_index/$',mgr_file_index,name='mgr_file_index'), 
    url(r'^clusmgr/get_dir_content/$',get_dir_content,name='get_dir_content'), 
    ...
    url(r'^clusmgr/process_stop/$',process_stop,name='process_stop'),
    ...
    url(r'^clusmgr/file_delete/$',file_delete,name='file_delete'),
